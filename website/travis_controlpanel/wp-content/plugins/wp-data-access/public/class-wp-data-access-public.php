...
class WP_Data_Access_Public
{
    ...
    public function enqueue_styles()
    {
        ...
        wp_register_style( 'wpda_material_icons', 'https://fonts.googleapis.com/icon?family=Material+Icons', [] );
        wp_register_style(
        ...
        wp_register_style( 'wpda_fontawesome_icons', WPDA::CDN_FONTAWESOME . 'fontawesome.min.css', [] );
        wp_register_style( 'wpda_fontawesome_icons_solid', WPDA::CDN_FONTAWESOME . 'solid.min.css', [] );
    }
    ...
    public function enqueue_scripts()
    {
        ...
        wp_register_script( 'purl', plugins_url( '../assets/js/purl.js', __FILE__ ), [] );
        // Register JQuery DataTables
        wp_register_script(
            'jquery_datatables',

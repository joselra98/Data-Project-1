...
class WP_Data_Access_Admin
{
    ...
    public function enqueue_styles()
    {
        ...
        if ( WPDA::is_plugin_page( $this->page ) ) {
            ...
            if ( self::PAGE_DASHBOARD === $this->page || self::PAGE_QUERY_BUILDER === $this->page || self::PAGE_PUBLISHER === $this->page ) {
            ...
            wp_enqueue_style( 'wpda_fontawesome_icons', WPDA::CDN_FONTAWESOME . 'fontawesome.min.css', [] );
            wp_enqueue_style( 'wpda_fontawesome_icons_solid', WPDA::CDN_FONTAWESOME . 'solid.min.css', [] );
            wp_enqueue_style( 'wpda_fontawesome_icons_regular', WPDA::CDN_FONTAWESOME . 'regular.min.css', [] );
        }
